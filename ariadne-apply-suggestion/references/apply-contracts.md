# Ariadne Apply Contracts

This reference defines the v1 application contract for Ariadne Suggestions. Human-facing output defaults to Simplified Chinese; preserve file paths, command names, API names, framework names, component names, identifiers, and suggestion ids.
...
- If any differ, block and recommend rerunning the producing `ariadne-suggest-*` capability.
