...
`ariadne-suggest-rules` proposes Runtime Rule updates. It may write suggestion JSON/MD under `.codebase/meta/suggestions/`, but it must not directly modify Runtime Rules.
...
```json
{
  ...
  "createdBy": "ariadne-suggest-rules",
  "agentScope": ["codex"],
  "risk": "medium",
  "sourceFingerprints": {},
  "targetPreconditions": [],
